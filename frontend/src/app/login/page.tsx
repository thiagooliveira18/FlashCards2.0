...
export default function Login(){
    return (
        <main className="w-screen h-screen flex items-center justify-center bg-sky-200">
            <div className="w-11/12 h-3/4 md:w-1/3 md:h-4/5 flex flex-col items-center border-zinc-400 border rounded-xl bg-gradient-to-t from-blue-950 via-blue-800 to-blue-700 drop-shadow-4xl">
