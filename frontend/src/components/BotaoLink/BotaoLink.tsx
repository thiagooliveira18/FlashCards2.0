...
export default function BotaoLink({ href, children, ...rest }: BotaoLink){
    ...
    const compNActive = "border-opacity-0 border-2 border-3th hover:bg-gradient-to-tr hover:from-blue-800 hover:to-green-600 hover:border-2 hover:border-white";
